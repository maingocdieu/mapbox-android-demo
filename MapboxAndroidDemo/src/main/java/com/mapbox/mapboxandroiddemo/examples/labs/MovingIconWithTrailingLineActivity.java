...
public class MovingIconWithTrailingLineActivity extends AppCompatActivity {
  ...
  private Point originCoffeeShop;
  private Point destinationAirport;
  private int count = 0;
      ...
      public void onMapReady(MapboxMap mapboxMap) {
        ...
        mapboxMap.setStyle(Style.LIGHT, new Style.OnStyleLoaded() {
          ...
          public void onStyleLoaded(@NonNull Style style) {
            ...
            // Set the originCoffeeShop location from a coffee shop in Addis Ababa
            originCoffeeShop = Point.fromLngLat(38.7508, 9.0309);

            // Set the destinationAirport to the Addis Ababa airport
            destinationAirport = Point.fromLngLat(38.795902, 8.984467);

            markerLinePointList = new ArrayList<>();

            getRoute(style, originCoffeeShop, destinationAirport);
          }
        });
      }
    });
    ...
    runnable = new Runnable() {
      ...
      public void run() {
        ...
        if ((routeCoordinateList.size() - 1 > count)) {
          ...
          Point nextLocationPoint = routeCoordinateList.get(count + 1);
          ...
          if (latLngEvaluator != null) {
            markerIconAnimator = ObjectAnimator
              .ofObject(latLngEvaluator, count == 0 ? new LatLng(
                originCoffeeShop.latitude(), originCoffeeShop.longitude())
  ...
  private void initSymbolLayer(@NonNull Style loadedMapStyle) {
    loadedMapStyle.addImage("moving-red-marker", BitmapUtils.getBitmapFromDrawable(
